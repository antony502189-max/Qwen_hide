...
public sealed class CoreTests
{
    ...
    [Fact] public void Target_architecture_parser_fails_closed_for_unreadable_paths() => Assert.Equal("unknown", ChatGPTProcessLocator.DetectPortableExecutableArchitecture("Z:\\does-not-exist.exe"));
